 ...
 * {@link #init(KeyStore)} to reload its configuration for
...
public final class ReloadingX509TrustManager implements X509TrustManager, CertificateNotification {
   ...
   * @param certStorage the cert storage for reading root CA certificates
  ...
  public ReloadingX509TrustManager(String type, TrustedCertStorage certStorage)
    ...
    trustManagerRef.set(init(certStorage.getKeyStore()));
  }
