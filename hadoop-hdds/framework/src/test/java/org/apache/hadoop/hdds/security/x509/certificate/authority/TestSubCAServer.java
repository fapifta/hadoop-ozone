...
public class TestSubCAServer {
  ...
  void testCertSignedByNonPrimarySCM() throws Exception {
    ...
    Future<OzoneCertPath> holder = rootCA.requestCertificate(csr.toEncodedFormat(),
        CertificateApprover.ApprovalType.TESTING_AUTOMATIC, SCM,
        String.valueOf(System.nanoTime()));
    assertTrue(holder.isDone());
    X509Certificate certificate = holder.get().getLeafCert();
    ...
    X509Certificate caCertificate = rootCA.getCaCertPath().getLeafCert();
    ...
    scmCA.init(securityConfig);
    assertEquals(scmCA.getCaCertPath().getLeafCert(), certificate);
  }
