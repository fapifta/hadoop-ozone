...
public class SCMCertificateClient extends DefaultCertificateClient {
  ...
  private void getRootCASignedSCMCert() {
    try {
      ...
      String scmCertificate = getScmSecureClient().getSCMCertificate(scmNodeDetailsProto, getEncodedString(csr));
  ...
  public CertificateServer initializeRootCertificateServer(
    ...
    RootCAServer rootCAServer = new RootCAServer(subject,
        cId, scmId, scmCertStore, pkiProfile, component, rootCertId, saveCertIdCallback);
